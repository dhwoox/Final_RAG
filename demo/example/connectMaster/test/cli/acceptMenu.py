...
class AcceptMenu:
  ...
  def getPendingList(self):
    try:
      devList = self.connectMasterSvc.getPendingList(self.gatewayID)
  ...
  def showAcceptFilter(self):
    try:
      filter = self.connectMasterSvc.getAcceptFilter(self.gatewayID)
  ...
  def allowAllDevices(self):
    try:
      ...
      self.connectMasterSvc.setAcceptFilter(self.gatewayID, filter)
