...
class TriggerActionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetConfig = channel.unary_unary(
                '/gsdk.action.TriggerAction/GetConfig',
        ...
        self.SetConfig = channel.unary_unary(
                '/gsdk.action.TriggerAction/SetConfig',
...
def add_TriggerActionServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'gsdk.action.TriggerAction', rpc_method_handlers)
...
class TriggerAction(object):
    ...
    def GetConfig(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gsdk.action.TriggerAction/GetConfig',
    ...
    def SetConfig(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gsdk.action.TriggerAction/SetConfig',
    ...
    def SetConfigMulti(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gsdk.action.TriggerAction/SetConfigMulti',
    ...
    def RunAction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gsdk.action.TriggerAction/RunAction',
